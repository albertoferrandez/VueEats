<template>
	<footer class="px-4 divide-y relative bottom-0 left-0 mt-8 text-gray-500 bg-emerald-300">
    ...
    py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        class="flex justify-center space-x-3 lg:justify-start">
			...
			<div class="grid grid-cols-2 text-xs gap-x-3 
        		gap-y-8 lg:w-2/3 sm:grid-cols-4">
				<div class="space-y-3">
		...
		<div class="py-6 text-sm text-center">© 2023 Proyecto realizado por Alberto Ferrandez. All rights reserved.</div>
	</footer>
</template>
